...
package de.azcore.azcoreRuntime.module.plugin.loader;
...
public class PluginClassLoader extends URLClassLoader {
    ...
    public synchronized Plugin addPluginFile(String pluginName, String classPath, String version, File jarFile) throws MalformedURLException {
        super.addURL(jarFile.toURI().toURL());
        return initPlugin(pluginName, classPath, version);
    }

    private Plugin initPlugin(String pluginName, String classPath, String version) {
