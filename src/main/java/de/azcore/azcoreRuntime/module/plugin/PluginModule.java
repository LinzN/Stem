 ...
 *
 */
package de.azcore.azcoreRuntime.module.plugin;

import de.azcore.azcoreRuntime.AZCoreRuntimeApp;
import de.azcore.azcoreRuntime.internal.containers.Module;
import de.azcore.azcoreRuntime.module.plugin.loader.PluginClassLoader;
...
public class PluginModule extends Module {
    ...
    private LinkedHashMap<String, Plugin> pluginList;
    ...
    private void loadPlugin(String pluginName, String classPath, String version, File jarFile, boolean enablePlugin) throws IOException {
        Plugin plugin = pluginClassLoader.addPluginFile(pluginName, classPath, version, jarFile);
    ...
    public boolean enablePlugin(String pluginName) {
        Plugin plugin = this.pluginList.get(pluginName);
        if (plugin == null) {
            return false;
        }
