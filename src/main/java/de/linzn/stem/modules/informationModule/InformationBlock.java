...
package de.linzn.stem.modules.informationModule;
...
public class InformationBlock {
    ...
    public void setDescription(String description, String eventText) {
        ...
        if (!this.disableLongDescription) {
            if (eventText != null) {
                this.longDescription = STEMApp.getInstance().getInformationModule().runAiTextEngine(eventText);
            } else {
                this.longDescription = STEMApp.getInstance().getInformationModule().runAiTextEngine(description);
            }
        } else {
